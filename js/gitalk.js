	...
	return function(e) {
		...
		Object.defineProperty(t, "__esModule", {
			...
			function(e) {
				...
				function C(e) {
					function t(e, t) {
						k(this), I.call(this, e, t, V), P.call(this, e, t)
					}
					return e = _({
						constructor: t
				...
				function O(e, t) {
					for (var n in t) t.hasOwnProperty(n) && (e[n] = T(t[n].concat(e[n] || Q), "getDefaultProps" === n || "getInitialState" === n || "getChildContext" === n))
				}
				...
				function P(e, t) {
					A.call(this, e, t), this.componentWillReceiveProps = T([A, this.componentWillReceiveProps || "componentWillReceiveProps"]), this.render = T([A, j, this.render || "render", D])
				}
				...
				function I(e, t, n) {
					G.Component.call(this, e, t), this.state = this.getInitialState ? this.getInitialState() : {}, this.refs = {}, this._refProxies = {}, n !== V && P.call(this, e, t)
				}
		...
		function s(e) {
			var t, n;
			return (t = M.exec(e)) ? 0 : (t = T.exec(e)) ? (n = 60 * parseInt(t[2], 10), "+" === t[1] ? -n : n) : (t = P.exec(e), t ? (n = 60 * parseInt(t[2], 10) + parseInt(t[3], 10), "+" === t[1] ? -n : n) : 0)
		}
		...
		var r = n(6),
			...
			s = function() {
				var e, t = n(31)("iframe"),
					r = i.length;
				for (t.style.display = "none", n(56).appendChild(t), t.src = "javascript:", e = t.contentWindow.document, e.open(), e.write("<script>document.F=Object<\/script>"), e.close(), s = e.F; r--;) delete s.prototype[i[r]];
				return s()
			};
		...
		"use strict";
		(function(t) {
			"production" === t.env.NODE_ENV ? e.exports = n(85) : e.exports = n(86)
		}).call(t, n(7))
		...
		(function(t) {
			var r = n(3),
				...
				u = n(177),
				s = n(75),
				c = "undefined" != typeof window && window.btoa && window.btoa.bind(window) || n(178);
			e.exports = function(e) {
		...
		(function(e) {
			...
			"production" !== e.env.NODE_ENV && function() {
				function e(e) {
					return "string" == typeof e || "function" == typeof e || e === b || e === C || e === _ || e === w || e === O || e === k || "object" == typeof e && null !== e && (e.$$typeof === T || e.$$typeof === M || e.$$typeof === x || e.$$typeof === S || e.$$typeof === N || e.$$typeof === P || e.$$typeof === A || e.$$typeof === j)
				}
				...
				var v = "function" == typeof Symbol && Symbol.for,
					...
					T = v ? Symbol.for("react.lazy") : 60116,
					P = v ? Symbol.for("react.fundamental") : 60117,
		...
		(function(t) {
			...
			"production" !== t.env.NODE_ENV && (c = function(e) {
				...
				return p.prototype = Error.prototype, P.checkPropTypes = u, P.resetWarningCache = u.resetWarningCache, P.PropTypes = P, P
			}
		}).call(t, n(7))
	}, function(e, t, n) {
		"use strict";
		...
		*/
		...
		! function() {
			...
			function n(e, n) {
				...
				var s = new t;
				return s.nodeName = e, s.children = u, s.attributes = null == n ? void 0 : n, s.key = null == n ? void 0 : n.key, void 0 !== P.vnode && P.vnode(s), s
			}
			...
			function i(e) {
				!e.__d && (e.__d = !0) && 1 == I.push(e) && (P.debounceRendering || setTimeout)(a)
			}
			...
			function C(e, t, n, r, o) {
				e.__x || (e.__x = !0, (e.__r = t.ref) && delete t.ref, (e.__k = t.key) && delete t.key, !e.base || o ? e.componentWillMount && e.componentWillMount() : e.componentWillReceiveProps && e.componentWillReceiveProps(t, r), r && r !== e.context && (e.__c || (e.__c = e.context), e.context = r), e.__p || (e.__p = e.props), e.props = t, e.__x = !1, 0 !== n && (1 !== n && !1 === P.syncComponentUpdates && e.base ? i(e) : N(e, 1, o)), e.__r && e.__r(e))
			}
				...
				if (!e.__x) {
					...
					if (y && (e.props = p, e.state = d, e.context = h, 2 !== t && e.shouldComponentUpdate && !1 === e.shouldComponentUpdate(s, l, f) ? x = !0 : e.componentWillUpdate && e.componentWillUpdate(s, l, f), e.props = s, e.state = l, e.context = f), e.__p = e.__s = e.__c = e.__b = null, e.__d = !1, !x) {
						...
						if ("function" == typeof M) {
							var T = c(i);
							a = _, a && a.constructor === M && T.key == a.__k ? C(a, T, 1, f, !1) : (E = a, e._component = a = S(M, T, f), a.__b = a.__b || g, a.__u = e, C(a, T, 0, f, !1), N(a, 1, n, !0)), O = a.base
					...
					if (!y || n ? L.unshift(e) : x || (m(), e.componentDidUpdate && e.componentDidUpdate(p, d, h), P.afterUpdate && P.afterUpdate(e)), null != e.__h)
		...
		(function(t, r) {
			...
			! function(t, n) {
				...
				function A(e, t) {
					this._instanceConstructor = e, this.promise = new e(p), this.promise[ee] || P(this.promise), H(t) ? (this.length = t.length, this._remaining = t.length, this._result = new Array(this.length), 0 === this.length ? x(this.promise, this._result) : (this.length = this.length || 0, this._enumerate(t), 0 === this._remaining && x(this.promise, this._result))) : S(this.promise, j())
				}
				...
				function G(e) {
					this[ee] = T(), this._result = this._state = void 0, this._subscribers = [], p !== e && ("function" != typeof e && R(), this instanceof G ? M(this, e) : F())
				}
						...
						return n.getIssue().then(function(e) {
							if (e) return N.axiosGithub.get(e.comments_url, {
								headers: {
									...
									Authorization: "token " + (n.accessToken || o)
								},
								params: {
									per_page: r,
									page: i
								...
								var t = n.state,
									...
									u = !1,
									s = o.concat(e.data);
								return (s.length >= a.comments || e.data.length < r) && (u = !0), n.setState({
									comments: s,
									isLoadOver: u,
									page: i + 1
								}), s
				...
				return (0, y.default)(t, e), (0, d.default)(t, [{
					...
					value: function() {
						var e = this,
							...
							o = t.number,
							a = t.accessToken,
							u = "/repos/" + n + "/" + r + "/issues/" + o;
						return new i.default(function(t, n) {
							N.axiosGithub.get(u, {
								headers: {
									Authorization: "token " + (e.accessToken || a)
								},
								params: {
									t: Date.now()
								}
					...
					value: function() {
						...
						return N.axiosGithub.get("/repos/" + n + "/" + r + "/issues", {
							headers: {
								Authorization: "token " + (this.accessToken || a)
							},
							params: {
					...
					value: function() {
						...
						})), this.isAdmin ? b.default.createElement("p", null, b.default.createElement(T.default, {
							onClick: this.handleIssueCreate,
							isLoading: n,
							text: this.i18n.t("init-issue")
						})) : null, !t && b.default.createElement(T.default, {
					...
					value: function() {
						...
						return b.default.createElement("div", {
							...
							className: "gt-error"
						}, "If you want to talk with each other. Please log in! ^_^"), !t && (n ? [this.noInit()] : [this.header(), this.comments()]))
					}
				}, {
					key: "accessToken",
					get: function() {
		...
		n(51), n(20), n(27), n(107), n(115), n(116), e.exports = n(0).Promise
	}, function(e, t, n) {
		var r = n(34),
			o = n(35);
		e.exports = function(e) {
		...
		P || (O = function(e) {
			...
			Promise: O
		}), n(26)(O, "Promise"), n(114)("Promise"), a = n(0).Promise, f(f.S + f.F * !P, "Promise", {
			reject: function(e) {
				var t = T(this);
		...
		n(119), e.exports = n(0).Object.assign
	}, function(e, t, n) {
		var r = n(4);
		r(r.S + r.F, "Object", {
			assign: n(120)
		...
		n(122), e.exports = n(0).Object.getPrototypeOf
	}, function(e, t, n) {
		var r = n(17),
			o = n(57);
		...
		n(127), n(51), n(132), n(133), e.exports = n(0).Symbol
	}, function(e, t, n) {
		"use strict";
		var r = n(1),
			o = n(12),
			...
			q = function(e, t, n) {
				return e === H && q(z, t, n), g(e), t = x(t, !0), g(n), o(B, t) ? (n.enumerable ? (o(e, L) && e[L][t] && (e[L][t] = !1), n = E(n, {
					enumerable: S(0, !1)
				})) : (o(e, L) || P(e, L, S(1, {})), e[L][t] = !0), V(e, t, n)) : P(e, t, n)
			},
			K = function(e, t) {
				g(e);
		...
		$ || (j = function() {
			...
			return this._k
		}), N.f = Q, k.f = q, n(69).f = C.f = ee, n(28).f = Z, O.f = te, i && !n(21) && u(H, "propertyIsEnumerable", Z, !0), h.f = function(e) {
			return X(d(e))
		}), a(a.G + a.W + a.F * !$, {
			Symbol: j
		});
		...
		n(136), e.exports = n(0).Object.setPrototypeOf
	}, function(e, t, n) {
		var r = n(4);
		r(r.S, "Object", {
		...
		e.exports = {
			set: Object.setPrototypeOf || ("__proto__" in {} ? function(e, t, r) {
				try {
					r = n(13)(Function.call, n(70).f(Object.prototype, "__proto__").set, 2), r(e, []), t = !(e instanceof Array)
				} catch (e) {
					t = !0
				}
				return function(e, n) {
		...
		*/
		...
		n(160), e.exports = n(0).Object.keys
	}, function(e, t, n) {
		var r = n(17),
			o = n(22);
		n(66)("keys", function() {
		...
		}, s.Cancel = n(77), s.CancelToken = n(185), s.isCancel = n(76), s.all = function(e) {
			return Promise.all(e)
		}, s.spread = n(186), e.exports = s, e.exports.default = s
	}, function(e, t) {
		function n(e) {
		...
		}, r.resolve = o, e.exports = r, r.id = 190
	}, function(e, t) {
		...
		n(20), n(222), e.exports = n(0).Array.from
	}, function(e, t, n) {
		"use strict";
		var r = n(13),
			o = n(4),
